<?php return array (
  ...
  'default.contextSettings.checklist.notPreviouslyPublished' => 'Bài gửi chưa được xuất bản trước đó, hoặc đang gửi cho một tạp chí khác xem xét (hoặc một lời giải thích đã được cung cấp trong Nhận xét cho Biên tập viên).',
  'default.contextSettings.checklist.fileFormat' => 'Tập tin bài gửi ở định dạng tệp tài liệu OpenOffice, Microsoft Word hoặc RTF.',
  'default.contextSettings.checklist.addressesLinked' => 'Nếu có sẵn, URL cho các tài liệu tham khảo đã được cung cấp.',
  'default.contextSettings.checklist.submissionAppearance' => 'Các văn bản là khoảng cách đơn; sử dụng phông chữ 12; sử dụng chữ nghiêng, thay vì gạch chân (trừ địa chỉ URL); và tất cả các hình minh họa, số liệu và bảng được đặt trong văn bản tại các điểm thích hợp, thay vì ở cuối bản thảo.',
  'default.contextSettings.checklist.bibliographicRequirements' => 'Văn bản tuân thủ các yêu cầu về trình bày văn bản và tài liệu tham khảo được nêu trong Hướng dẫn cho tác giả.',
