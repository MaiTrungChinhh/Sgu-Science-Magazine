...
function content_66a34cd722a421_29864448 (Smarty_Internal_Template $_smarty_tpl) {
...
>
	$(function() {
		...
		$('#staticPageForm').pkpHandler(
			...
			{
				previewUrl: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_PAGE') ? constant('ROUTE_PAGE') : null),'page'=>"pages",'op'=>"preview"),$_smarty_tpl ) ) ));?>
